...
@interface YCProduct (SWIFT_EXTENSION(YCProductSDK))
/// 开启恒爱血压自动测量
+ (void)startHenAIAutomaticMeasurement:(CBPeripheral * _Nullable)peripheral macAddress:(NSString * _Nonnull)macAddress completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 开启恒爱血压测量
+ (void)startHenAIBPMeasure:(CBPeripheral * _Nullable)peripheral mac:(NSString * _Nonnull)mac;
/// 停止恒爱血压测量
+ (void)stopHenAIBPMeasureWithCompletion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 恒爱初始化
+ (void)initHenAIBPWithAccount:(NSString * _Nonnull)account password:(NSString * _Nonnull)password name:(NSString * _Nonnull)name gender:(NSInteger)gender macAddress:(NSString * _Nonnull)macAddress deviceName:(NSString * _Nonnull)deviceName deviceHAModel:(NSString * _Nonnull)deviceHAModel description:(NSString * _Nonnull)description birthday:(NSString * _Nonnull)birthday height:(NSInteger)height weight:(NSInteger)weight completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion SWIFT_METHOD_FAMILY(none);
/// 恒爱血压校准
+ (void)henAIBloodPressureCalibration:(CBPeripheral * _Nullable)peripheral systolicBloodPressure:(uint8_t)systolicBloodPressure diastolicBloodPressure:(uint8_t)diastolicBloodPressure completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 获取恒爱血压模型
+ (void)gethenAIBloodPressureModelWithMacAddress:(NSString * _Nonnull)macAddress completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
/// 删除恒爱血压模型
+ (void)deletehenAIBloodPressureModelWithMacAddress:(NSString * _Nonnull)macAddress completion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
+ (void)stopCalibrationWithCompletion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
+ (void)stopMessareCalibrationWithCompletion:(void (^ _Nullable)(enum YCProductState, id _Nullable))completion;
@end
